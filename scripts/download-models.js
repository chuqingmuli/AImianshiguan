...
const modelUrls = [
  {
    url: 'https://huggingface.co/fakerybakery/kokoro-82m-v2/resolve/main/kokoro-82m-v2.onnx',
    filename: 'kokoro-82m-v2.onnx'
  },
  {
    url: 'https://huggingface.co/fakerybakery/kokoro-82m-v2/resolve/main/voices.json',
